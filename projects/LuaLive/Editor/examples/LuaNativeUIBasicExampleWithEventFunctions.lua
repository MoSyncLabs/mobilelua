...
This is done by calling:
  ...
  NativeUI:OnWidgetEvent(widgetHandle, eventFunction)
  
To disable an event function, call:

  NativeUI:OnWidgetEvent(widgetHandle, nil)
...
NativeUI:OnWidgetEvent(ButtonSayHello, function(widgetEvent)
...
NativeUI:OnWidgetEvent(ButtonSayHi, function(widgetEvent)
