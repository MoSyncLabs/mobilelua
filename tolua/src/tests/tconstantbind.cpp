...
** Generated automatically by tolua 5.1.4 on Mon Apr 18 14:56:04 2011.
*/
...
LUALIB_API int luaopen_tconstant (lua_State* tolua_S)
{
 ...
 // #define FIRST has unknown data type: string // #define SECOND has unknown data type: string tolua_constant(tolua_S,"ONE",ONE);
 tolua_constant(tolua_S,"TWO",TWO);
 tolua_module(tolua_S,"M",0);
 tolua_beginmodule(tolua_S,"M");
 // #define FIRST has unknown data type: string // #define SECOND has unknown data type: string tolua_constant(tolua_S,"ONE",M_ONE);
 tolua_constant(tolua_S,"TWO",M_TWO);
 tolua_endmodule(tolua_S);
 tolua_cclass(tolua_S,"A","A","",NULL);
 tolua_beginmodule(tolua_S,"A");
 // #define FIRST has unknown data type: string // #define SECOND has unknown data type: string tolua_constant(tolua_S,"ONE",A::ONE);
