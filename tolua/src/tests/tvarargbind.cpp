/*
** Lua binding: tvararg
** Generated automatically by tolua 5.1.4 on Mon Apr 18 14:56:13 2011.
*/
...
static int tolua_tvararg_A_bounce00(lua_State* tolua_S)
{
 ...
 {
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
  tolua_index i = ((tolua_index)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'bounce'",NULL);
#endif
 {
  tolua_index tolua_ret = (tolua_index)  self->bounce((i-1)
);
